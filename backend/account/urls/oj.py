...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI, UserChangeEmailForAuthAPI,
                        ...
                        UserLoginAPI, UserLogoutAPI, UserResendEmailForAuthAPI, UsernameOrEmailCheck,
...
urlpatterns = [
    ...
    url(r"^resend_email_for_auth/?$", UserResendEmailForAuthAPI.as_view(), name="resend_email_for_auth_api"),
