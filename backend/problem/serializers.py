...
from .models import Problem, ProblemRuleType, ProblemSet, ProblemSetGroup, ProblemTag, ProblemIOMode
...
class ProblemSetGroupSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProblemSetGroup
        fields = "__all__"
